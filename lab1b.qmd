...
```
The three lowest median rating scores are not in the Bronx. However, there are no so many neighborhoods from the Bronx offering rooms. Most of the low ranked neighborhoods, between 4.5 and 4.7 belong to Bronx and Staten Island, however both boroughs get high ranked neighborhoods. Most of the Brooklyn and Manhattan neighborhoods are high ranked between 4.8 and 5. And, apparently Queens hast the biggest offering of renting neighborhoods in New York City. In general these observarions highlight the poor economic output of the poorest borough of the city, Bronx. 